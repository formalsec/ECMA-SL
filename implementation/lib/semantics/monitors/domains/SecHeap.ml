...
let insert  (heap : 'sl t) (loc : Loc.t) (secobj : ('sl SecObject.t)) (struct_lvl : 'sl) (obj_lvl : 'sl) : unit =
...
let get_field (heap : 'sl t) (loc : Loc.t) (field : Field.t) : ('sl * 'sl) option =
...
let new_sec_prop (heap : 'sl t) (loc : Loc.t) (field : Field.t) (exists_lvl : 'sl) (val_lvl : 'sl) : bool =
...
let str (str_sl : 'sl -> string) (heap : 'sl t): string =
  Hashtbl.fold
    (fun loc (obj,struct_lvl, object_lvl) acc ->
       (Printf.sprintf "%s|-> {%s}_{%s, %s}\n" loc (SecObject.str str_sl obj) (str_sl struct_lvl) (str_sl object_lvl)) ^ acc)
    heap ""
