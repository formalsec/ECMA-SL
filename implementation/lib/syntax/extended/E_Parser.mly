...
%token ABS ACOS ASIN ATAN ATAN_2 CEIL COS EXP FLOOR LOG_E LOG_10 MAX MIN POW RANDOM SIN SQRT TAN PI MAX_VALUE MIN_VALUE COSH LOG_2 SINH TANH FLOAT64_TO_LE_BYTES FLOAT64_TO_BE_BYTES FLOAT32_TO_LE_BYTES FLOAT32_TO_BE_BYTES INT_TO_BE_BYTES FLOAT64_FROM_LE_BYTES FLOAT64_FROM_BE_BYTES FLOAT32_FROM_LE_BYTES FLOAT32_FROM_BE_BYTES INT_FROM_BYTES UINT_FROM_BYTES BYTES_TO_STRING FLOAT_TO_BYTE
%token PLUS MINUS TIMES DIVIDE MODULO EQUAL GT LT EGT ELT IN_OBJ IN_LIST TO_PRECISION TO_EXPONENTIAL TO_FIXED
%token NOT LLEN LNTH LADD LPREPEND LCONCAT LREVERSE HD TL TLEN TNTH FST SND LREMOVELAST LSORT SLEN SLEN_U SNTH SNTH_U SSUBSTR SSUBSTR_U ARRAY_MAKE ANTH ASET ALEN LIST_TO_ARRAY
...
prefix_unary_op_target:
  ...
  | BYTES_TO_STRING  e = e_expr_target;
    { E_Expr.UnOpt (Oper.BytesToString, e) } %prec unopt_prec
  | FLOAT_TO_BYTE e = e_expr_target;
    { E_Expr.UnOpt (Oper.FloatToByte, e) } %prec unopt_prec
  | ALEN  e = e_expr_target;
    { E_Expr.UnOpt (Oper.ArrayLen, e) } %prec unopt_prec
  |  LIST_TO_ARRAY e = e_expr_target;
    { E_Expr.UnOpt (Oper.ListToArray, e) } %prec unopt_prec
