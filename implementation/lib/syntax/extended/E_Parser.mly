...
%token NOT LLEN LNTH LREMNTH LSET LADD LPREPEND LCONCAT LREVERSE HD TL TLEN TNTH FST SND LREMOVELAST LSORT SLEN SLEN_U SNTH SNTH_U SSUBSTR SSUBSTR_U ARRAY_MAKE ANTH ASET ALEN LIST_TO_ARRAY
...
prefix_unary_op_target:
  ...
  | IS_NAN; e = e_expr_target;
    { E_Expr.UnOpt (Oper.IsNaN, e) } %prec unopt_prec
