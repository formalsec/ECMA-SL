...
%token ABS ACOS ASIN ATAN ATAN_2 CEIL COS EXP FLOOR LOG_E LOG_10 MAX MIN POW RANDOM SIN SQRT TAN PI MAX_VALUE MIN_VALUE ACOSH ASINH ATANH CBRT CLZ32 COSH LOG_2 SINH TANH
...
prefix_unary_op_target:
  ...
  | ACOSH; e = e_expr_target;
    { E_Expr.UnOpt (Oper.Acosh, e) } %prec unopt_prec
  | ASINH; e = e_expr_target;
    { E_Expr.UnOpt (Oper.Asinh, e) } %prec unopt_prec
  | ATANH; e = e_expr_target;
    { E_Expr.UnOpt (Oper.Atanh, e) } %prec unopt_prec
  | CBRT; e = e_expr_target;
    { E_Expr.UnOpt (Oper.Cbrt, e) } %prec unopt_prec
  | CLZ32; e = e_expr_target;
    { E_Expr.UnOpt (Oper.Clz32, e) } %prec unopt_prec
