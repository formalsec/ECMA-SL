...
let typedefs : (string, EType.t) Hashtbl.t ref =
  ref (Hashtbl.create !Config.default_hashtbl_sz)

let resolve_typedef (tref : EType.t) : EType.t =
  match tref with
...
let check_literal_expr (expr : EExpr.t) (tref : t) (texpr : t) : unit =
  match (tref, texpr) with
...
let check_tuple_type (expr : EExpr.t) (tref : t) (texpr : t)
...
let check_union_expr (_expr : EExpr.t) (tref : t) (texpr : t)
...
let check_union_type (expr : EExpr.t) (tref : t) (texpr : t)
  (type_check_f : t -> t -> unit) : unit =
...
let check_obj_type (expr : EExpr.t) (tref : t) (texpr : t)
  (type_check_f : EExpr.t -> t -> t -> unit) : unit =
  try
    match (tref, texpr) with
...
let check_runtime_type (expr : EExpr.t) (tref : t) (texpr : t) : unit =
  match (tref, texpr) with
...
let check_user_type (expr : EExpr.t) (tref : t) (texpr : t)
  (type_check_f : t -> t -> unit) : unit =
...
let rec type_check (expr : EExpr.t) (tref : t) (texpr : t) : unit =
  match (tref, texpr) with
  | (_, AnyType) -> ()
  | (AnyType, _) -> ()
  | (UnknownType, _) -> ()
