...
module Impl = struct
  ...
  let to_precision ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (Flt _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(float, integer)" [ v1; v2 ]
  ...
  let s_nth_u ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (Str _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(string, integer)" [ v1; v2 ]
  ...
  let s_split ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (Str _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(string, string)" [ v1; v2 ]
  ...
  let array_nth ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (Arr arr, Int i) -> (
      ...
      with _ -> Eval_operator.unexpected_err 2 op_lbl "index out of bounds" )
    | (Arr _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(array, integer)" [ v1; v2 ]
  ...
  let array_set ((v1, v2, v3) : Val.t * Val.t * Val.t) : Val.t =
    ...
    | (Arr arr, Int i) -> (
      ...
      with _ -> Eval_operator.unexpected_err 2 op_lbl "index out of bounds" )
    | (Arr _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(array, integer, any)" [ v1; v2; v3 ]
    | _ ->
      Eval_operator.bad_arg_err 1 op_lbl "(array, integer, any)" [ v1; v2; v3 ]
  ...
  let list_remove_nth ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (List _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(list, integer)" [ v1; v2 ]
  ...
  let int_from_le_bytes ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    let int_bytes =
      ...
      with _ ->
        Eval_operator.bad_arg_err 1 op_lbl "(byte array, integer)" [ v1; v2 ]
    in
    match v2 with
  ...
  let atan2 ((v1, v2) : Val.t * Val.t) : Val.t =
    ...
    | (Flt _, _) ->
      Eval_operator.bad_arg_err 2 op_lbl "(float, float)" [ v1; v2 ]
