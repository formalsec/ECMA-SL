...
// function traverse(func, state, obj) {
//   const aux1 = func(obj, state);

//   function func2(obj1, obj2) {
//     const auxOne = traverse(func, aux1.state, obj1);
//     const auxTwo = traverse(func, auxOne.state, obj2);
//     return {
//       ret: aux1.ret.concat(auxOne.ret, auxTwo.ret),
//       state: auxTwo.state,
//     };
//   }
...
//   switch (obj.type) {
//     case "FunctionDeclaration":
//       const aux2 = traverse(func, aux1.state, obj.body);
//       return {
//         ret: aux1.ret.concat(aux2.ret),
//         state: aux2.state,
//       };

//     case "BlockStatement":
//       // funcArr
//       return obj.body.reduce((acc, obj) => {
//         var aux = traverse(func, acc.state, obj);
//         return {
//           ret: acc.ret.concat(aux.ret),
//           state: aux.state,
//         };
//       }, aux1);

//     case "AssignmentExpression":
//       return func2(obj.left, obj.right);

//     case "WhileStatement":
//       return func2(obj.test, obj.body);
//   }
// }
